...
import {embedUrl, text, type BlockData} from '@/lib/blockData';
...
export default function ContactMap({data}: {data?: BlockData}) {
        ...
        <div className="row g-4">
          <div className="col-xl-6 col-lg-6">
            <div className="google-map-items">
              <iframe
                src={embedUrl(data, 'map_embed_url', DEFAULT_MAP)}
                style={{border: 0}}
                allowFullScreen
                loading="lazy"
              />
            ...
            <div className="contact-right-content-in">
              <div className="contact-box">
                <div className="section-title mb-0">
                  <span className="sub-title text-white tz-sub-tilte tz-sub-anim tx-subTitle">{text(data, 'sub_title', t('subTitle'))}</span>
                  <h2 className="tx-title text-white sec_title tz-itm-title tz-itm-anim">{text(data, 'title', t('title'))}</h2>
                  <div className="sec-line mt-3 mb-4">
                    <img src="/assets/img/inner/white-sec-line.png" alt="img" />
                  </div>
                  <p className="text-white">{text(data, 'description', t('description'))}</p>
                </div>
              </div>
